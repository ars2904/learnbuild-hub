  ...
  return (
    <div className="flex flex-col min-h-screen bg-white pt-6 pb-20 md:pt-10 md:pb-28 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* ================= HERO COURSE HEADER ================= */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-10 pb-10 border-b border-slate-200">
          
          {/* Left Text & Overview */}
          <div className="lg:col-span-7 flex flex-col items-start">
            <div className="flex flex-wrap items-center gap-2 mb-4">
              <span className="px-3 py-1 rounded-full bg-blue-100 text-brand-blue text-xs font-extrabold border border-blue-200">
                {course.category}
              </span>
            ...
            <div className="flex flex-wrap items-center gap-6 p-4 rounded-2xl bg-slate-50 border border-slate-200/80 mb-8 w-full text-xs font-semibold text-slate-700">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Batch Size: <strong className="text-slate-900">20 Seats</strong></span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              <button
                ...
                className="w-full sm:w-auto px-8 py-4 rounded-full bg-brand-blue hover:bg-blue-700 text-white font-black text-sm uppercase tracking-wider shadow-xl shadow-brand-blue/30 transition-all hover:scale-105 flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto px-8 py-4 rounded-full bg-slate-900 hover:bg-slate-800 text-white font-black text-sm uppercase tracking-wider shadow-xl transition-all hover:scale-105 flex items-center justify-center gap-2 border border-slate-700"
              >
          ...
          <div className="lg:col-span-5">
            <div className="bp-card rounded-3xl overflow-hidden bg-white border border-slate-200 shadow-2xl p-4">
              ...
              <div className="space-y-2.5 px-2 pb-2 text-xs font-semibold text-slate-600">
        ...
        <div className="sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-slate-200 mb-12">
          <div className="flex items-center gap-8 overflow-x-auto py-3 no-scrollbar text-sm font-bold">
            {[
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-8 space-y-16">
            ...
            <div id="instructors" className="scroll-mt-24 pt-4">
              <div className="mb-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                {instructors.map((inst) => (
                  <div
                    key={inst.id}
                    className="p-6 rounded-3xl bg-white border border-slate-200/90 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col items-center text-center justify-between group"
                  >
                    <div className="flex flex-col items-center w-full">
                      {/* Centered Circular Avatar Container */}
                      <div className="relative w-24 h-24 rounded-full bg-purple-100/70 p-2 mb-4 flex items-center justify-center border border-purple-200 overflow-hidden shadow-xs">
                        <img
                          src={inst.avatar}
                          alt={inst.name}
                      ...
                      {/* Name & Role */}
                      <h3 className="text-lg font-black text-slate-900 mb-1">{inst.name}</h3>
                      <p className="text-xs font-bold text-slate-500 mb-4">{inst.role}</p>
                      ...
                      <div className="flex flex-wrap items-center justify-center gap-1.5 mb-6">
                        {inst.skills.slice(0, 3).map((sk, idx) => (
                          <span
                            key={idx}
                            className="px-2.5 py-1 rounded-full bg-blue-50 text-brand-blue text-[11px] font-bold border border-blue-100"
                          >
                            {sk}
                          </span>
                        ))}
            ...
            {/* FAQs Section */}
            <div id="faqs" className="scroll-mt-24 pt-4 border-t border-slate-200">
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className="w-full text-left font-black text-sm text-slate-900 flex items-center justify-between gap-4 focus:outline-none"
                      >
                        <span>{faq.q}</span>
